        ...
        injectCss({
          ...
          css: `        
            ...
            ${headings.reduce<string>((style, heading) => {
              ...
              const { lineHeight, fontFamily, fontWeight, fontSize } =
                theme.typography[heading];
              const isNumber = (value: typeof fontSize): value is number => {
              ...
              return style.concat(`
                .md-typeset ${heading} {
                  ...
                  font-size: ${
                    isNumber(fontSize) ? pxToRem(fontSize * 0.6) : fontSize // 60% of the size defined because it is too big
                  };
                }
              `);
            }, '')}
